...
<body class="hold-transition login-page" style="background: url('<?php echo base_url(); ?>image/fondo_login.jpg') no-repeat center center fixed	;" >
<div class="login-box" >

  <!-- /.login-logo -->
  <div class="login-logo">
  	<img src="image/logoINCOYS1.png" alt="INCOYS" align="center" />
  </div>
...
<!-- iCheck http://localhost/domicilio/app/template/plugins/iCheck/icheck.min.js-->
