          ...
          <ul class="nav">
            ...
            <li class="nav-item" style="background: #20a8d8;">
              <a class="nav-link" style="cursor: pointer;">
                <i class="nav-icon icon-clock" style="color: #fff;"></i> En proceso
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="terminados.php">
                <i class="nav-icon icon-check"></i> Terminados
              </a>
            </li>
            <li class="nav-item">
              ...
              <div class="col-lg-12">
                <div class="card">
                  <div class="card-header">
                    <i class="fa fa-align-justify"></i> Fallas reportadas en proceso
                  ...
                  <div class="card-body">
                    ...
                    if (isset($_REQUEST['b'])) { ?>
                      <div id="resultados-hide" class="d-none">Resultado: <b><?php echo $cont; ?></b> reportes en total ordenados por <b><?php if ($_REQUEST['b'] == 'num_operativo') { echo 'Numero de operativo'; } elseif ($_REQUEST['b'] == 'fecha_operativo') { echo 'Fecha de operativo'; } elseif ($_REQUEST['b'] == 'num_vehiculo') { echo 'Numero interno de vehiculo'; }; ?></b>.</div>
                    <?php } elseif (isset($_REQUEST['m'])) { ?>
                      <div id="resultados-hide" class="d-none">Resultado: <b><?php echo $cont; ?></b> reportes en total de la modalidad <b><?php echo $_REQUEST['m']; ?></b>.</div>
                    <?php } elseif (isset($_REQUEST['e'])) { ?>
                      <div id="resultados-hide" class="d-none">Resultado: <b><?php echo $cont; ?></b> reportes en estado <b><?php echo $_REQUEST['e']; ?></b>.</div>
                    <?php } elseif (isset($_REQUEST['a'])) { ?>
                      <div id="resultados-hide" class="d-none">Resultado: <b><?php echo $cont; ?></b> reportes en total agregados por <b><?php echo $_REQUEST['a']; ?></b>.</div>
                    <?php } elseif (isset($_REQUEST['buscar']) && !isset($_REQUEST['mes'])) { ?>
                      <div id="resultados-hide" class="d-none">Resultado: <b><?php echo $cont; ?></b> reportes en total de la busqueda <b>"<?php echo $_REQUEST['buscar']; ?>"</b>.&nbsp;&nbsp;&nbsp; <a href="index.php?p=1"><span class="badge badge-info p-2">Limpiar busqueda</a></div>
                    <?php } elseif (isset($_REQUEST['buscar']) && isset($_REQUEST['mes'])) { ?>
                      <div id="resultados-hide" class="d-none">Resultado: <b><?php echo $cont; ?></b> reportes en total del mes de <b><?php echo $_REQUEST['mes']; ?></b>.</div>
                    <?php } else{ ?>
                      <div id="resultados-hide" class="d-none">Resultado: <b><?php echo $cont; ?></b> reportes en total.</div>
                    <?php } ?>
                    
                    <nav>
                      <ul class="pagination">
                        <li class="page-item <?php echo $_REQUEST["p"] == 1 ? "disabled" : ""; ?>">
                          <a class="page-link" href="index.php?p=<?php echo $_REQUEST["p"] - 1; ?>">Atras</a>
                        </li>
                        ...
                        <li class="page-item <?php echo $_REQUEST["p"] == $num_item ? "disabled" : ""; ?>">
                          <a class="page-link" href="index.php?p=<?php echo $_REQUEST["p"] + 1; ?>">Siguiente</a>
                        </li>
                      </ul>
                    </nav>
                  </div>
