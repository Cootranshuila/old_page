...
$sql = $objConexion->prepare('SELECT * from operativos where id_operativo = :edit');
...
<html lang="es">
  ...
  <body class="app header-fixed sidebar-fixed aside-menu-fixed sidebar-lg-show">
        ...
        <div class="container-fluid">
          <div class="animated fadeIn">
            ...
            <?php 
              ...
              $sqlProce = $objConexion->prepare('SELECT * from procedimiento where id_op_foreing = :edit');
              $sqlProce->bindParam(':edit', $_REQUEST['edit']);
              $sqlProce->execute();
              $cont = $sqlProce->rowCount();

              if ($cont == 1) {
                $consulta = "SELECT * from operativos o, procedimiento p where o.id_operativo = :num and o.id_operativo = p.id_op_foreing";
              } else {
                $consulta = "SELECT * from operativos where id_operativo = :num";
              }
                  ...
                  <div class="card-body">
                    ...
                    <div class="qa-message-content mt-3 mb-3" id='div-finalizar'>
                            <div class="text-center">
                              <h3><b>¿Finalizar operativo si no tiene observación?</b></h3>
                            </div>
                          </div>
                          <div class="text-center">
                            <button class="btn btn-success btn-lg" onclick="finalizar('Si')"> Si</button>
            ...
            <div class="row mb-3">
              <div class="col-lg-12">
                 <div class="qa-message-list" id="wallmessages">
                         ...
                         <div class="message-inner">
                            <div class="message-head clearfix">
                               <div class="user-detail">
                                  ...
                                  <button class="btn btn-primary text-right float-right <?php echo empty($row['llamado_atencion']) ? "" : "d-none"; echo empty($row['sancion']) ? "" : "d-none"; ?>" id="llamado_atencion">Solo llamado de atención</button>
                                  <div class="post-meta">
                                     <div class="asker-meta">
                                        <span class="qa-message-what"></span>
                            ...
                            <div class="qa-message-content mb-5" id='div-sancion'>
                              <?php if (isset($row['llamado_atencion']) AND $row['llamado_atencion'] == 'Si') { ?>
                            ...
                            <button class="btn btn-success text-right float-right <?php echo !empty($row['sancion']) ? "d-none" : ""; echo $row['llamado_atencion'] == 'Si' ? "d-none" : ""; ?>" id="enviar-sancion" style="margin-top: -35px;">Enviar</button>
                         </div>
                      </div>
                    </div>
                    ...
                    <?php } else { ?>
                      <div class="message-item <?php if (empty($row['f_ini_suspen']) AND $row['llamado_atencion'] != 'Si') { echo 'd-none'; } ?>" id="finalizar">
                    <?php } ?>
    ...
    <script>
      ...
      // PETICION AJAX PARA AGREGAR EL LLAMADO DE ATENCION
      $("#llamado_atencion").click(function(){

        var num = $("#num_op").val();

        $.ajax({
          type: 'POST',
          url: 'validaciones/llamado_atencion.php',
          data: {num:num},
          success: function(data){
            // console.log(data);
            Command: toastr["success"]("Llamado de atención agrego correctamente.", "Correcto!");
            $("#div-sancion").html(data);
            $("#enviar-sancion").addClass('d-none');
            $("#llamado_atencion").addClass('d-none');
        ...
        $.ajax({
          ...
          success: function(data){
            if (data == 'Ok') {
              ...
              setTimeout("redireccionarPagina("+num+")", 700);
            } else {
