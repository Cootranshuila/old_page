  ...
  <body class="app header-fixed sidebar-fixed aside-menu-fixed sidebar-lg-show">
                      ...
                      <tbody>
                        <?php
                          ...
                          <td class="text-center">
                            <a href="ver_operativo.php?edit=<?php echo $row['id_operativo']; ?>" data-toggle="tooltip" data-placement="top" title="Ver proceso"><button type="button" class="btn btn-info btn-pill" value="Editar"><i class="far fa-eye"></i></button></a>
                            <a href="reporte_pdf.php?san=<?php echo $row['id_operativo']; ?>" target="_blank" data-toggle="tooltip" data-placement="top" title="Descargar"><button type="button" class="btn btn-success btn-pill" value="DescargarSan" id="myBtn"><i class="fas fa-file-download"></i></button></a>
                          </td>
                          <?php } 
                            if (isset($_REQUEST['b'])) {
    ...
    <script>
      ...
      $('#mes').on('change', function() {  
        ...
        if (this.value == 'Enero') {
          window.location.href="index.php?buscar=2020-01&mes=Enero&p=1";
        } 
        if (this.value == 'Febrero') {
          window.location.href="index.php?buscar=2020-02&mes=Febrero&p=1";
        }
        if (this.value == 'Marzo') {
          window.location.href="index.php?buscar=2020-03&mes=Marzo&p=1";
        }
        if (this.value == 'Abril') {
          window.location.href="index.php?buscar=2020-04&mes=Abril&p=1";
        }
        if (this.value == 'Mayo') {
          window.location.href="index.php?buscar=2020-05&mes=Mayo&p=1";
        }
        if (this.value == 'Junio') {
          window.location.href="index.php?buscar=2020-06&mes=Junio&p=1";
        }
        if (this.value == 'Julio') {
          window.location.href="index.php?buscar=2020-07&mes=Julio&p=1";
        }
        if (this.value == 'Agosto') {
          window.location.href="index.php?buscar=2020-08&mes=Agosto&p=1";
        }
        if (this.value == 'Septiembre') {
          window.location.href="index.php?buscar=2020-09&mes=Septiembre&p=1";
        }
        if (this.value == 'Octubre') {
          window.location.href="index.php?buscar=2020-10&mes=Octubre&p=1";
        }
        if (this.value == 'Noviembre') {
          window.location.href="index.php?buscar=2020-11&mes=Noviembre&p=1";
        }
        if (this.value == 'Diciembre') {
          window.location.href="index.php?buscar=2020-12&mes=Diciembre&p=1";
        }
        if (this.value == 'no') {
          window.location.href="index.php?p=1";
        }
      ...
      $('#order-modal').on('change', function() {  
        ...
        if (this.value == 'num_operativo') {
          $("#consulta").html("SELECT * FROM operativos WHERE 1 = 1"+where1+where2+where3+where4+" ORDER BY id_operativo DESC");
