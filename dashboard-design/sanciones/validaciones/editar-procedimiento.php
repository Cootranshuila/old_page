...
$sql0 = $objConexion->prepare('UPDATE operativos set estado = "En descargos" where id_operativo = :num');
$sql0->bindParam(':num', $_REQUEST['num']);
$sql0->execute();

$sql = $objConexion->prepare('UPDATE procedimiento set procedimiento = :procedimiento where id_op_foreing = :num');
