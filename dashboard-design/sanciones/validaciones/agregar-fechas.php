...
$sql0 = $objConexion->prepare('UPDATE operativos set estado = "Sancion aplicada" where id_operativo = :num');
$sql0->bindParam(':num', $_REQUEST['num']);
$sql0->execute();

//SE AGREGAN LAS FECHAS DE SUSPENCION Y TERMINACION DE SANCION
$sql1 = $objConexion->prepare('UPDATE procedimiento set f_ini_suspen = :f_ini_suspen, f_fin_suspen = :f_fin_suspen where id_op_foreing = :num');
