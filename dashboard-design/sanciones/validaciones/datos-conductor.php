...
$sql = $objConexion->prepare('INSERT into procedimiento (id_op_foreing, cargo, vinculacion) values (:num, :cargo, :vinculacion)');
...
<?php } else { ?>
	<div class="row text-center">
      <h4 class="col-md-6">Ha ocurrido un error, contacte al desarrollador. <?php print_r( $sql->errorInfo() ); ?></h4>
    </div>
<?php }
