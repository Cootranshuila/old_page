                      ...
                      <tbody>
                        <?php
                          ...
                          <td class="text-center">
                            <a href="ver_terminados.php?edit=<?php echo $row['id_operativo']; ?>" data-toggle="tooltip" data-placement="top" title="Ver proceso"><button type="button" class="btn btn-info btn-pill" value="Editar"><i class="far fa-eye"></i></button></a>
