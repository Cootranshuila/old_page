	...
	$html = '<header class="clearfix">
		    ...
		    <main>
		      <table class="tableThree">
		        <thead>
		          <tr>
		            <th colspan="3"><img class="ini" src="../img/logo1.jpg"></th>
		            <th colspan="3"><img class="ini" src="../img/logo/logo.jpg"></th>
		          </tr>
		        </thead>
		        <tbody>
					
		          	echo "<tr>";
						echo "<td align="center" colspan="6"><b>FORMATO ÚNICO DE EXTRACTO DEL CONTRATO DEL SERVICIO PÚBLICO DE TRANSPORTE TERRESTRE AUTOMOTOR ESPECIAL<br><br>No: 441025001 '.$row['contratoAno'].' '.$row['contratoCodigo'].' 0001</b></td>";					
					echo "</tr>";
					echo "<tr>";
					...
					echo "</tr>";
					echo "<tr>";			
						echo "<td align="center" colspan="2"><b><h6>VIGILADO</h6></b><br><img class="fin" src="../img/logo3.jpg"></td>";
