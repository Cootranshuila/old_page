...
if (isset($_REQUEST['btn-ruta'])) {
  ...
  $sql = $conexion->prepare("INSERT into ruta (rutaCodigo, rutaNombre) values (NULL, :ruta)");
...
if (isset($_REQUEST['enviar_co'])) {
  ...
  // if (empty($_REQUEST['contratoConduc2Nombre'])) {
  //   $contratoConduc2Nombre = NULL;
  //   $contratoConduc2Cedula = NULL;
  //   $contratoConduc2Licencia = NULL;
  //   $contratoConduc2Vigencia = NULL;
  // } else {
  //   $contratoConduc2Nombre = $_REQUEST['contratoConduc2Nombre'];
  //   $contratoConduc2Cedula = $_REQUEST['contratoConduc2Cedula'];
  //   $contratoConduc2Licencia = $_REQUEST['contratoConduc2Licencia'];
  //   $contratoConduc2Vigencia = $_REQUEST['contratoConduc2Vigencia'];
  // }

  // if (empty($_REQUEST['contratoConduc3Nombre'])) {
  //   $contratoConduc3Nombre = NULL;
  //   $contratoConduc3Cedula = NULL;
  //   $contratoConduc3Licencia = NULL;
  //   $contratoConduc3Vigencia = NULL;
  // } else {
  //   $contratoConduc3Nombre = $_REQUEST['contratoConduc3Nombre'];
  //   $contratoConduc3Cedula = $_REQUEST['contratoConduc3Cedula'];
  //   $contratoConduc3Licencia = $_REQUEST['contratoConduc3Licencia'];
  //   $contratoConduc3Vigencia = $_REQUEST['contratoConduc3Vigencia'];
  // }
  ...
  // $sql->bindParam(":contratoConduc2Nombre", $contratoConduc2Nombre);
  // $sql->bindParam(":contratoConduc2Cedula", $contratoConduc2Cedula);
  // $sql->bindParam(":contratoConduc2Licencia", $contratoConduc2Licencia);
  // $sql->bindParam(":contratoConduc2Vigencia", $contratoConduc2Vigencia);
  // $sql->bindParam(":contratoConduc3Nombre", $contratoConduc3Nombre);
  // $sql->bindParam(":contratoConduc3Cedula", $contratoConduc3Cedula);
  // $sql->bindParam(":contratoConduc3Licencia", $contratoConduc3Licencia);
  // $sql->bindParam(":contratoConduc3Vigencia", $contratoConduc3Vigencia);
                ...
                <tr>
                  ...
                  <td colspan="1">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control col-md-12" id="contratoAno" name="contratoAno" value="2020" readonly="">
                    </div>
                  </td>
                </tr>
...
if (!isset($_SESSION['user'])) {
	...
	<div class="wrapper fadeInDown">
	  <div id="formContent">
	    ...
	    <h2 class="active h2login"> Ingresar </h2>

	    <div class="fadeIn first">
	      <img src="../assets/images/user.png" id="icon" alt="User Icon" />
	    </div>
              ...
              <tr>
                ...
                <td colspan="1">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control-plaintext col-md-8" id="contratoAno" name="contratoAno" value="2020" readonly="">
                  </div>
                </td>
