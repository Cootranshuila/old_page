	...
	<div class="container">
		...
		<div class="infoPersonal">
			...
			<?php foreach ($resConEdu as $keyEdu) { 
				...
				<p class="infoP" style="margin-top: -36px;margin-left: 450px;font-size: 13pt;"><?php echo $keyEdu['fecha_terminacion'] ?></p>
	...
	<page>
		<div class="container">
			...
			<div class="infoPersonal">
				...
				<?php if (strlen($ema) >= 26) { ?>
					<p class="tituloP">Correo electronico: </p><p class="infoP" style="margin-top: -12px; font-size: 12pt;"><?php echo $ema ?></p>
				<?php }else{ ?>
