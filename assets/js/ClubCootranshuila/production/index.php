<?php
  ...
  //QUERY para obtener el nombre del usuario que inicio session y el rol
  ...
  //QUERY para saber el total de usuarios actual
  $sql_cont= $objConexion->prepare("select * from usuarios where estado_usuario = 'Activo'");
  $sql_cont->execute();

  $cont_usuarios = $sql_cont->rowCount();
...
<html lang="es">
  <head>
    ...
    <title>Cootranshuila Team | Inicio</title>
        ...
        <div class="right_col" role="main">
          ...
          <div class="row tile_count">
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top"><i class="fa fa-group"></i> Total Usuarios</span>
              <div class="count"><?php echo $cont_usuarios; ?></div>
              <!-- <span class="count_bottom"><i class="green">4% </i> From last Week</span> -->
            </div>
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top"><i class="fa fa-calendar"></i> Semana</span>
              <div class="count"><?php echo $_SESSION['semana']; ?></div>
            ...
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top"><i class="fa fa-calculator"></i> Total Aportes</span>
          ...
          <div class="row">
            <div class="col-md-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Cootranshuila Team <small> - Panel</small></h2>
                        <div class="filter">
                    ...
                    <div class="x_content">
                        ...
                        <div class="bs-example" data-example-id="simple-jumbotron">
                            <div class="jumbotron">
                                <h3>Bienvenido, <b><?php echo $nombre_usuario; ?></b></h3>
                            ...
                            <div class="panel panel-body">
                                ...
                                <div class="row">
                                    <div class="col-xs-4">
                                        ...
                                        <p>Porcentaje de la cuota semanal del total de usuarios de la semana 0</p>
                                    ...
                                    <div class="col-xs-4">
                                        ...
                                        <p>Porcentaje del aporte semanal al club de la semana 0</p>
                                    ...
                                    <div class="col-xs-4">
                                        ...
                                        <p>Porcentaje total de cuotas y aportes de la semana 0</p>
